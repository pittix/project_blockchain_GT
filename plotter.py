...
data_original = pd.read_hdf("results/simulation_results_all_01.hdf")
...
for node_num in node_nums:
    for app_rate in app_rates:
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig('report/figures/obj_funcs/obj_func_vs_{}_N_{}_app_{}.eps'.format(FIXED_PARAM, node_num, app_rate))
